...
func TestChannelRootRoutesKeepTrailingSlashCompatibility(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "", authz.ChannelRead, controller.GetAllChannels)
	assertChannelRoutePermission(t, http.MethodGet, "/", authz.ChannelRead, controller.GetAllChannels)
	assertChannelRoutePermission(t, http.MethodPost, "", authz.ChannelSensitiveWrite, controller.AddChannel)
	assertChannelRoutePermission(t, http.MethodPost, "/", authz.ChannelSensitiveWrite, controller.AddChannel)
	assertChannelRoutePermission(t, http.MethodPut, "", authz.ChannelWrite, controller.UpdateChannel)
	assertChannelRoutePermission(t, http.MethodPut, "/", authz.ChannelWrite, controller.UpdateChannel)
}
