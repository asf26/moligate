...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/assistant/version", controller.GetAssistantVersion)
		...
		// Order ledger: package purchases and wallet recharges in one list.
		orderAdminRoute := apiRouter.Group("/order/admin")
		orderAdminRoute.Use(middleware.AdminAuth())
		{
			orderAdminRoute.GET("/list", controller.AdminListOrders)
		}
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/usage-preview", controller.AdminPreviewSubscriptionUsage)
			...
			subscriptionAdminRoute.PATCH("/user_subscriptions/:id/groups", controller.AdminUpdateUserSubscriptionGroups)
