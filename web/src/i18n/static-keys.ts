...
export const STATIC_I18N_KEYS = [
  ...
  // Public reference-style homepage
  '18+ models',
  ...
  'View documentation',
  'Connect now',
  'Claude · GPT direct access · available in China',
  'One-stop AI model gateway',
  'Claude · GPT direct access',
  ...
  'Why choose us',
  'A multi-model AI gateway built for developers',
  'Transparent billing',
  'Complete support',
  '5-minute integration',
  'Call it just like the official Claude API',
  'Point base_url to your gateway and replace api_key with your access key. Everything else stays the same.',
  'Monthly subscriptions · ready to use',
  'is the most popular choice for developers. You can also start with pay-as-you-go billing from $5.',
  'Ultra $500 plan · built for high-demand users',
  'Heavy users get 12x quota per dollar, with a $400 daily limit and up to $6000 monthly.',
  'Subscribe to Ultra',
  'New',
  'per month',
  'Compatible with Claude Code and OpenAI SDK',
  'Claude and GPT model families',
  ...
  'Which models can I use with Moligate?',
  ...
  'How are usage and prices calculated?',
  ...
  'How do I call Moligate from my application?',
  ...
  'curl',
  'Basic',
  'For daily development and light usage',
  'Plus',
  'An advanced choice, twice the Basic plan',
  'Standard',
  'Most popular for everyday individual development',
  'Pro',
  'Professional development and high-concurrency production',
  'Ultra',
  'For high-demand users, $1 = 12x quota',
  'Daily limit {{value}}',
  'Weekly limit {{value}}',
  'Monthly limit {{value}}',
  'per month',
  ...
  // Subscription model packages
  'Model packages',
  'Choose a model package',
  ...
  'Nano Banana',
  'Included models',
  'Claude Code Max models for agentic development',
  'Kiro Claude models for coding and agent workflows',
  'GPT and OpenAI models for text, vision and image work',
  'Gemini models for fast multimodal workloads',
  'DeepSeek, Qwen, GLM, Kimi, Doubao and MiniMax models',
  'GPT Image models for image generation',
  'Nano Banana models for image generation',
  'Model package settings',
  'Model family',
  'Automatically infer from plan metadata',
  ...
  'Please enter a usage rate from 0 to 100',
  'Quota multiplier',
  'Image allowance',
  ...
  'Subscription Plans',
  'Subscription Usage',
  'Review active plans and usage aggregated by model.',
  'Usage by model',
  'No model usage yet',
  'Last 30 days',
  ...
  'Creative Canvas',
  'Visual workspace for image and video generation.',
