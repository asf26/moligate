...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  const customNavigation = props.navContent !== undefined
  const customActions = props.rightContent !== undefined
        ...
        >
          ...
          >
            ...
            <div className='hidden items-center gap-0.5 sm:flex'>
              ...
              {!customActions && showLanguageSwitcher && <LanguageSwitcher />}
              {!customActions && showThemeSwitch && <ThemeSwitch />}
              {!customActions && showNotifications && (
                <NotificationPopover
