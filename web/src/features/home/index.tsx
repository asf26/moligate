  ...
  return (
    <PublicLayout
      ...
      headerProps={{
        ...
        className: 'home-reference-header',
        navContent: (
          <a
            href={docsUrl}
            target='_blank'
            rel='noopener noreferrer'
            className='home-reference-header-link'
          >
            {t('Docs')}
          </a>
        ),
        rightContent: (
          <Button
            className='home-reference-header-console'
    ...
    >
      <main>
        ...
        <FAQ />
        <CTA isAuthenticated={isAuthenticated} docsUrl={docsUrl} />
      </main>
    </PublicLayout>
  )
}
