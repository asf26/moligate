    ...
    return (
        <>
            <div className="pointer-events-none absolute left-0 right-0 top-0 z-50 flex h-16 items-center justify-between pl-1 pr-4">
                ...
                <div className="pointer-events-auto flex items-center gap-1.5">{isEmbedded ? null : <UserStatusActions variant="canvas" onOpenShortcuts={() => setShortcutsOpen(true)} />}</div>
            </div>
