...
export type InstalledPlugin = {
    ...
    enabled: boolean;
    local?: boolean; // Local plugin discovered in web/public/plugins; refreshed from its URL at startup.
    official?: boolean; // Installed from the platform's official registry.
    installedAt: string;
};
