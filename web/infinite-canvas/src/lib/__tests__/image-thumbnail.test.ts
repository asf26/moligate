...
test("scales thumbnails down to the max edge and never up", () => {
    expect(getThumbnailDimensions(4000, 3000, 768)).toEqual({ width: 768, height: 576 });
    expect(getThumbnailDimensions(320, 240, 768)).toEqual({ width: 320, height: 240 });
});
