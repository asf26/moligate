...
type Task struct {
	...
	VideoAccountId int                   `json:"video_account_id,omitempty" gorm:"index"`
...
func InitTask(platform constant.TaskPlatform, relayInfo *commonRelay.RelayInfo) *Task {
	...
	if relayInfo != nil && relayInfo.ChannelMeta != nil {
		if relayInfo.ChannelMeta.ChannelType == constant.ChannelTypeGemini ||
			...
			relayInfo.ChannelMeta.ChannelType == constant.ChannelTypeMiniMax {
	...
	if relayInfo != nil && relayInfo.VideoAccount != nil {
		privateData.Key = relayInfo.VideoAccount.APIKey
		privateData.VideoAccountId = relayInfo.VideoAccount.ID
	}
	...
	t := &Task{
		...
		VideoAccountId: func() int {
			if relayInfo.VideoAccount != nil {
				return relayInfo.VideoAccount.ID
			}
			return 0
		}(),
		Platform:    platform,
