...
// InvalidateUserCache is the exported cache invalidation entry point used by
// state-changing model flows.
func InvalidateUserCache(userId int) error {
	return invalidateUserCache(userId)
}

// UpdateUserGroupCache updates the cached group while retaining the current
// auth-version fence used by the rest of the user cache implementation.
