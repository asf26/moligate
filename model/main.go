...
` + "`model_family`" + ` varchar(32) DEFAULT '',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "applicable_groups", DDL: "`applicable_groups` text"},
		{Name: "model_family", DDL: "`model_family` varchar(32) DEFAULT ''"},
		{Name: "included_models", DDL: "`included_models` text"},
		...
		{Name: "bonus_resources", DDL: "`bonus_resources` text"},
		{Name: "total_amount", DDL: "`total_amount` bigint NOT NULL DEFAULT 0"},
		{Name: "daily_amount", DDL: "`daily_amount` bigint NOT NULL DEFAULT 0"},
		{Name: "weekly_amount", DDL: "`weekly_amount` bigint NOT NULL DEFAULT 0"},
		{Name: "monthly_amount", DDL: "`monthly_amount` bigint NOT NULL DEFAULT 0"},
